...
return [
    "account" => [
        ...
        "activation_code_placeholder" => "Masukkan kode aktivasi",
        ...
        "change_details" => "Untuk mengubah detail ini, harap konfirmasikan kata sandi Anda saat ini.",
        ...
        "deactivate" => "Non aktifkan akunmu?",
        "deactivate_change" => "aku merubah pikiranku",
        "deactivate_confirm" => "Konfirmasikan Nonaktifkan Akun",
        "deactivate_notice" => "Akun Anda akan dinonaktifkan dan detail Anda dihapus dari situs.\nAnda dapat mengaktifkan kembali akun Anda kapan saja dengan masuk kembali.",
        "deactivate_password" => "Untuk melanjutkan, silakan masukkan kata sandi Anda:",
        "deactivate_toggle" => "Nonaktifkan akun",
        "email" => "Email",
        "email_not_verified" => "Alamat email Anda belum diverifikasi.",
        "email_placeholder" => "Masukkan email Anda",
        "email_resend" => "Kirim email verifikasi lagi",
        "email_verify" => "Anda harus memverifikasi akun Anda jika tidak, itu dapat dihapus. Silakan periksa email Anda untuk memverifikasi.",
        "enter_your" => "Masukkan",
        "force_secure" => "Paksa protokol yang aman",
        "force_secure_desc" => "Selalu mengarahkan URL dengan skema HTTPS.",
        "full_name" => "Nama Lengkap",
        "full_name_placeholder" => "Masukkan nama lengkapmu",
        ...
        "new_password_placeholder" => "Masukan kata sandi yang baru",
        "password" => "Kata Sandi",
        "password_placeholder" => "Pilih sebuah kata kunci",
        "password_reset" => "Setel Ulang Kata Sandi",
        "password_reset_complete" => "Reset kata sandi selesai, sekarang Anda dapat masuk.",
