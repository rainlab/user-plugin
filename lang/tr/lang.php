...
return [
    "account" => [
        ...
        "activation_code_placeholder" => "Aktivasyon kodunu girin",
        ...
        "change_details" => "Bu ayrıntıları değiştirmek için lütfen mevcut şifrenizi onaylayın.",
        ...
        "deactivate" => "Hesabınızı devre dışı bırakın?",
        "deactivate_change" => "Fikrimi değiştirdim",
        "deactivate_confirm" => "Hesabı Devre Dışı Bırakmayı Onayla",
        "deactivate_notice" => "Hesabınız devre dışı bırakılacak ve bilgileriniz siteden kaldırılacak.\nTekrar oturum açarak hesabınızı istediğiniz zaman yeniden etkinleştirebilirsiniz.",
        "deactivate_password" => "Devam etmek için lütfen şifrenizi girin:",
        "deactivate_toggle" => "Aktif edilmemiş hesap",
        "email" => "Email",
        "email_not_verified" => "E-posta adresiniz henüz doğrulanmadı.",
        "email_placeholder" => "E-postanızı giriniz",
        "email_resend" => "Doğrulama e-postasını tekrar gönderin",
        "email_verify" => "Hesabınızı doğrulamanız gerekir, aksi takdirde silinebilir. Doğrulamak için lütfen e-postanızı kontrol edin.",
        "enter_your" => "Girin",
        ...
        "new_password_placeholder" => "yeni bir şifre gir",
        "password" => "Parola",
        "password_placeholder" => "Bir parola seç",
        "password_reset" => "Şifreyi yenile",
        "password_reset_complete" => "Şifre sıfırlama tamamlandı, şimdi oturum açabilirsiniz.",
    ...
    "login" => ["attribute_email" => "Eposta", "attribute_username" => "Üye Adı"],
    "plugin" => [
