...
return [
    "account" => [
        ...
        "activation_code_placeholder" => "Entrez le code d'activation",
        ...
        "change_details" => "Pour modifier ces informations, veuillez confirmer votre mot de passe actuel.",
        ...
        "deactivate_change" => "j'ai changé d'avis",
        "deactivate_confirm" => "Confirmer la désactivation du compte",
        "deactivate_notice" => "Votre compte sera désactivé et vos coordonnées supprimées du site.\nVous pouvez réactiver votre compte à tout moment en vous reconnectant.",
        "deactivate_password" => "Pour continuer, veuillez saisir votre mot de passe:",
        "deactivate_toggle" => "Désactiver le compte",
        "email" => "E-mail",
        "email_not_verified" => "Votre adresse e-mail n'a pas encore été vérifiée.",
        "email_placeholder" => "Entrer votre Email",
        "email_resend" => "Renvoyez l'e-mail de vérification",
        "email_verify" => "Vous devez vérifier votre compte, sinon il pourrait être supprimé. Veuillez vérifier votre e-mail pour vérifier.",
        ...
        "new_password_placeholder" => "entrer un nouveau mot de passe",
        "password" => "Mot de passe",
        "password_placeholder" => "Choisissez un mot de passe",
        "password_reset" => "Réinitialiser le mot de passe",
        "password_reset_complete" => "La réinitialisation du mot de passe est terminée, vous pouvez maintenant vous connecter.",
