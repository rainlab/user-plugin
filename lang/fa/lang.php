...
return [
    "account" => [
        ...
        "activation_code_placeholder" => "کد فعال سازی را وارد کنید",
        ...
        "banned" => "",
        "change_details" => "برای تغییر این جزئیات ، لطفاً گذرواژه فعلی خود را تأیید کنید.",
        "code_param" => "پارامتر کد فعال سازی",
        "code_param_desc" => "پارامتر آدرس صفحه جهت استفاده در کد فعال سازی بهنگام ثبت نام",
        "current_password" => "رمز عبور فعلی",
        "deactivate" => "حساب خود را غیرفعال کنید؟",
        "deactivate_change" => "نظرم عوض شد",
        "deactivate_confirm" => "غیرفعال کردن حساب",
        "deactivate_notice" => "حساب شما غیرفعال خواهد شد و جزئیات شما از سایت حذف می شود.\nمی توانید هر وقت خواستید با ورود به سیستم ، دوباره حساب خود را فعال کنید.",
        "deactivate_password" => "برای ادامه ، لطفا رمز عبور خود را وارد کنید:",
        "deactivate_toggle" => "غیرفعال کردن حساب",
        "email" => "پست الکترونیکی",
        "email_not_verified" => "آدرس ایمیل شما هنوز تأیید نشده است",
        "email_placeholder" => "ایمیل خود را وارد کنید",
        "email_resend" => "دوباره ایمیل تأیید را ارسال کنید",
        "email_verify" => "باید حساب خود را تأیید کنید در غیر این صورت ممکن است حذف شود. لطفاً ایمیل خود را بررسی کنید.",
        "enter_your" => "وارد کن",
        "force_secure" => "",
        "force_secure_desc" => "",
        "full_name" => "نام کامل",
        "full_name_placeholder" => "نام کامل خود را وارد کنید",
        ...
        "new_password_placeholder" => "یک رمز جدید وارد کنید",
        "password" => "کلمه عبور",
        "password_placeholder" => "یک رمز عبور انتخاب کنید",
        "password_reset" => "بازنشانی گذرواژه",
        "password_reset_complete" => "بازنشانی گذرواژه کامل شد ، اکنون می توانید وارد سیستم شوید.",
        ...
        "save" => "صرفه جویی",
        "sign_in" => "ورود",
        "stay_logged_in" => "وارد سیستم شوید",
