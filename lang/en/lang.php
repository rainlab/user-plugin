...
return [
    "account" => [
        ...
        "change_details" => "To change these details, please confirm your current password.",
        ...
        "deactivate_change" => "I changed my mind",
        "deactivate_confirm" => "Confirm Deactivate Account",
        "deactivate_notice" => "Your account will be disabled and your details removed from the site.\nYou can reactivate your account any time by signing back in.",
        "deactivate_password" => "To continue, please enter your password:",
        "deactivate_toggle" => "Deactivate account",
        "email" => "Email",
        "email_not_verified" => "Your email address has not yet been verified.",
        "email_placeholder" => "Enter your email",
        "email_resend" => "Send the verification email again",
        "email_verify" => "You should verify your account otherwise it may be deleted. Please check your email to verify.",
        ...
        "password_reset_complete" => "Password reset complete, you may now sign in.",
