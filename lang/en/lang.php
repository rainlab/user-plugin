...
return [
    ...
    'users' => [
        ...
        'activing' => 'Activing...',
        'activate_warn_title' => 'User not activated!',
        'activate_warn_desc' => 'This user has not been activated and will be unable to sign in.',
        ...
        'activated_succ' => 'User has been activated successfully!',
    ...
    'account' => [
        ...
        'succ_activation' => 'Successfully activated your account.',
        'succ_saved' => 'Settings successfully saved!',
        ...
        'email_not_verified_desc' => 'You should verify your account otherwise it may be deleted. Please check your email to verify.<a href="javascript:;" data-request="onSendActivationEmail">Send the verification email again</a>.',
        'country' => 'Country',
        'state' => 'State',
        'sign_in' => 'Sign in',
        'register' => 'Register',
        ...
        'password' => 'Password',
        'chose_password' => 'Choose a password',
        'enter_password' => 'Enter your password',
        'register' => 'Register',
        'login' => 'Login',
        'enter_login' => 'Enter your login',
        'enter_company' => 'Enter your company or business name',
        'address' => 'Address',
        'enter_address' => 'Enter your street address',
        'city_suburb' => 'City / Suburb',
        'enter_city_suburb' => 'Enter your city or suburb',
        'postal_code' => 'Postal code',
        'enter_postal_code' => 'Enter your zip / post code',
    ...
    'reset_password' => [
        ...
        'reset_complete' => 'Password reset complete, you may now sign in.',
