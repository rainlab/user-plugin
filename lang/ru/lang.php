...
return [
    "account" => [
        ...
        "activation_code_placeholder" => "Введите код активации",
        ...
        "change_details" => "Чтобы изменить эти данные, пожалуйста, подтвердите свой текущий пароль.",
        "code_param" => "Параметр кода",
        "code_param_desc" => "Параметр, в котором передаётся код активации.",
        "current_password" => "Текущий пароль",
        "deactivate" => "Отключить учетную запись?",
        "deactivate_change" => "я передумал",
        "deactivate_confirm" => "Подтвердите деактивацию аккаунта",
        "deactivate_notice" => "Ваша учетная запись будет отключена, а ваши данные удалены с сайта.\nВы можете активировать свою учетную запись в любое время, выполнив вход.",
        "deactivate_password" => "Чтобы продолжить, пожалуйста, введите ваш пароль:",
        "deactivate_toggle" => "Деактивировать аккаунт",
        "email" => "Почта",
        "email_not_verified" => "Ваш адрес электронной почты еще не подтвержден.",
        "email_placeholder" => "Введите адрес электронной почты",
        "email_resend" => "Отправьте письмо с подтверждением еще раз",
        "email_verify" => "Вы должны подтвердить свой аккаунт, в противном случае он может быть удален. Пожалуйста, проверьте свою электронную почту, чтобы подтвердить.",
        ...
        "password" => "Пароль",
        "password_placeholder" => "Выберите пароль",
        "password_reset" => "Сброс пароля",
        "password_reset_complete" => "Сброс пароля завершен, теперь вы можете войти.",
