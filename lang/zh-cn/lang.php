...
return [
    ...
    'users' => [
        ...
        'impersonate_user' => '冒充用户',
        'impersonate_confirm' => '冒充该用户? 通过登出来恢复到原来的状态.',
        'impersonate_success' => '你现在正在冒充该用户',
        ...
        'activate_selected' => '激活选定的用户',
        'activate_selected_confirm' => '激活选中的用户?',
        'activate_selected_empty' => '没有选中要激活的用户.',
        'activate_selected_success' => '成功激活选中的用户.',
        'deactivate_selected' => '停用选中的用户',
        'deactivate_selected_confirm' => '停用选中的用户?',
        'deactivate_selected_empty' => '没有选中要停用的用户.',
        'deactivate_selected_success' => '成功停用所选用户.',
    ...
    'account' => [
        'account' => '账号',
        'account_desc' => '用户管理表单.',
        'banned' => '对不起,该用户目前没有激活.如果您需要进一步协助，请与我们联系.',
        'redirect_to' => '跳转到',
        'redirect_to_desc' => '在更新,登录或者注册后跳转页面.',
        'code_param' => '激活码参数',
        'code_param_desc' => '用于注册激活代码的页面URL参数',
        'force_secure' => '强制使用安全协议',
        'force_secure_desc' => '重定向URL始终使用HTTPS模式.',
    ...
    'session' => [
        ...
        'allowed_groups_description' => '选择允许或不允许所有的组群',
        'redirect_title' => '跳转至',
        'redirect_desc' => '如果访问被拒绝要跳转的页面.',
        'logout' => '成功退出!',
        'stop_impersonate_success' => '你不在是冒充用户.'
    ]
];
