<?php return [
    ...
    'users' => [
        ...
        'impersonate_user' => '模拟用户',
        'impersonate_confirm' => '确定要模拟该用户吗？你可以通过退出登陆退回到原来的状态。',
        'impersonate_success' => '你当前正在模拟该用户',
        ...
        'delete_selected_empty' => '未选择任何要删除的用户。',
        'delete_selected_success' => '成功删除所选用户。',
        'activate_selected' => '激活选中',
        'activate_selected_confirm' => '确定要激活选中的用户吗？',
        'activate_selected_empty' => '没有选中为何要激活的用户。',
    ...
    'account' => [
        ...
        'failed_not_registered' => '无法登陆用户 :email ，因为该账户尚未注册！',
    ],
    'reset_password' => [
        'reset_password' => '重置密码',
    ...
    'session' => [
        ...
        'allowed_groups_description' => '选择允许的群组，或者留空以允许所有群组',
        'redirect_title' => '跳转至',
        'redirect_desc' => '拒绝访问时重定向到页面的名字。',
        'logout' => '你已经成功退出登陆！',
        'stop_impersonate_success' => '你已经停止模拟用户。',
    ],
];
